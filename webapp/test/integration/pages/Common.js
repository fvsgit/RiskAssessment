sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("riskassessment/app", ".html");
		...
		return Opa5.extend("riskassessment.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["riskassessment/localService/mockserver"], function (mockserver) {
